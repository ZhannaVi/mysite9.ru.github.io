 ...
 * @package shopstar
 */
define( 'SHOPSTAR_THEME_VERSION' , '1.1.31' );
...
function shopstar_scripts() {
	...
	//} else if ( get_theme_mod( 'shopstar-font-awesome-version', customizer_library_get_default( 'shopstar-font-awesome-version' ) ) == '5.5.0' ) {
